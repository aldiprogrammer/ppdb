        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-12">
                <div class="row gx-5 row-cols-1 row-cols-md-2">
                    <div class="col sm-6">
                        <h4 class="text-center fw-bold mb-3">New Password</h4>
                        <div class="card border-primary shadow">
                            <div class="card-body">
                                <form method="post" action="<?= base_url('app/ubah_password') ?>">
                                    <div class="form-group mt-3">
                                        <label>Email</label> 
                                        <input type="email" name="email" value="<?= $this->session->email ?>"  class="form-control" readonly>
                                    </div>
