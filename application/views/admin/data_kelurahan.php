    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title">  <i class="fa fa-user"></i> Data Kelurahan</h3>


        </div>
        <div class="box-body">
          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModaltambah">Tambah Kelurahan</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?= base_url('admin/add_kel') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label>Keluarah</label>
                    <input type="text" name="kel" required class="form-control">
                  </div>
        ...
        <div class="box-body">
          <nav>
           <p class="mb-4">Cari berdasarkan nama Keluarah </p>
           <form class="form-inline" method="post" action="<?= base_url('admin/kelurahan') ?>">
            <div class="row">
              ...
              <?php foreach($kel as $data){ ?>
                <tr>
                  ...
                  <td>
                    ...
                    $kec = $this->db->get_where('tbl_kecamatan', ['id' => $data['district_id']])->row_array();
                    echo $kec['name'];
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form method="post" action="<?= base_url('admin/hapus_kel') ?>">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form method="post" action="<?= base_url('admin/edit_kel') ?>"  enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $data['id'] ?>">

                        <div class="form-group">
                          <label>Kabupaten</label>
                          <input type="text" name="kec" value="<?= $kec['name'] ?>" class="form-control" required readonly>
                        </div>

                        <div class="form-group">
                          <label>Keluarah</label>
                          <input type="text" name="kel" value="<?= $data['name'] ?>" class="form-control" required>
                        </div>
