    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title">  <i class="fa fa-user"></i> Data Provinsi</h3>


        </div>
        <div class="box-body">
          <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModaltambah">Tambah Provinsi</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?= base_url('admin/add_prov') ?>" enctype="multipart/form-data">


                    <div class="form-group">
                      <label>Provinsi</label>
                      <input type="text" name="prov" required class="form-control">
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form method="post" action="<?= base_url('admin/hapus_prov') ?>">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form method="post" action="<?= base_url('admin/edit_prov') ?>"  enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $data['id'] ?>">

                            <div class="form-group">
                              <label>Provinsi</label>
                              <input type="text" name="prov" value="<?= $data['name'] ?>" class="form-control" required>
                            </div>
