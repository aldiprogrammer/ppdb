                ...
                <tbody>
                  ...
                  <?php foreach($siswa as $data){ ?>
                    ...
                    <td>
                     ...
                     -->
                     <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModaldetail<?= $data['id'] ?>">Detail</button>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form method="post" action="<?= base_url('admin/edit_siswa') ?>"  enctype="multipart/form-data">
                          <input type="hidden" name="id" value="<?= $data['id'] ?>">

                          <div class="form-group">
                            <label>Kode pendaftaran</label>
                            <input type="text" name="kode" value="<?= $data['kode_pendaftaran'] ?>" class="form-control" required readonly>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="kode_user" required>
                              ...
                              <?php foreach ($user as $data2) { ?>
                                <option value="<?= $data2['kode_user'] ?>"><?= $data2['username'] ?></option>
                              <?php } ?>
                          ...
                          <div class="form-group">
                            <label>Tempat lahir</label>
                            <textarea class="form-control" name="tempat_lahir" required><?= $data['tempat_lahir'] ?></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            <label>No NIK</label>
                            <input type="number" maxlength="16" name="no_nik" value="<?= $data['no_nik'] ?>" class="form-control" required>
                          </div>
                          ...
                          <div class="form-group">
                            <label>Kode pos</label>
                            <input type="number" name="kode_pos" class="form-control" value="<?= $data['kode_pos'] ?>" required>
                          </div>
                          ...
                          <div class="form-group">
                            <label>Pekerjaan ayah</label>
                            <select class="form-control" name="pekerjaan_ayah" >
                              <option><?= $data['pekerjaan_ayah'] ?></option>
                              <option value="">-- Pilih pekerjaan --</option>
                              <option>PNS</option>
                              <option>Karyawan</option>
                              <option>Wirausaha</option>
                          ...
                          <div class="form-group">
                            <label>Pekerjaan ibu</label>
                            <select class="form-control" name="pekerjaan_ibu">
                              <option><?= $data['pekerjaan_ibu'] ?></option>
                              <option value="">-- Pilih pekerjaan --</option>
                              <option>Ibu rumah tangga</option>
                              <option>PNS</option>
                              <option>Karyawan</option>
                          ...
                          <div class="form-group">
                            <label>Alamat orang tua</label>
                            <textarea class="form-control" name="alamat_ortu" required><?= $data['alamat_orang_tua'] ?></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            <label>No hp</label>
                            <input type="number" required class="form-control" name="no_hp" value="<?= $data['no_hp'] ?>">
                          </div>
                ...
                <div class="modal fade" id="exampleModaldetail<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="form-group">
                        <label>Nama ayah</label>
                        <div><?= $data['nama_ayah'] ?></div>
                      </div>
                      <hr />

                      <div class="form-group">
                        <label>Pekerjaan ayah</label>
                        <div><?= $data['pekerjaan_ayah'] ?></div>
                      </div>
                      <hr />
                      ...
                      <div class="form-group">
                        <label>Pekerjaan ibu</label>
                        <div><?= $data['pekerjaan_ibu'] ?></div>
                      </div>
                      <hr />

                      <div class="form-group">
                        <label>Alamat ortu</label>
                        <div><?= $data['alamat_orang_tua'] ?></div>
                      </div>
                      <hr />
